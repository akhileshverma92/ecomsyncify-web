...
import { RefreshCw, Package, ShoppingCart, BarChart3, TrendingUp, Users, Award, Globe, Shield, Sparkles, Target, Star, Headphones, Handshake,Eye } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ backgroundColor: themeColors.white }}>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: themeColors.white }}>
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-start mb-8 sm:mb-12">
               ...
               <div className="relative order-2 md:order-1" style={{ minHeight: '300px', height: 'auto' }}>
                {/* Mobile: Single Image with Text Card */}
                <div className="md:hidden space-y-4">
                  ...
                  {/* Text Card - Below image on mobile */}
                  <div 
                    className="rounded-xl p-4 shadow-xl transition-all duration-500"
                    style={{
          ...
          >
            {[
              ...
              <div
                key={idx}
                className="text-center p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl border-2 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 touch-manipulation"
                style={{
                  backgroundColor: themeColors.white,
        ...
        {/* What We Do Section */}
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
              {whatWeDo.map((item, index) => (
                <div
                  key={index}
                  className="what-we-do-card p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border-2 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 relative overflow-hidden touch-manipulation"
                  style={{
                    backgroundColor: themeColors.white,
                    borderColor: themeColors.grayLight,
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 md:mb-16">
              {[
                ...
                <div
                  key={index}
                  className={`rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 border-2 touch-manipulation ${
           ...
           <div className="mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              {[
                ...
                <div
                  key={section.id}
                  className={`rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 transition-all duration-1000 hover:shadow-xl hover:-translate-y-1 border-2 touch-manipulation ${
          ...
          {/* Our Team Section */}
          <div 
            className={`mb-12 sm:mb-16 md:mb-20 transition-all duration-1000 delay-600 ${
