...
alt="Customer support illustration"
          ...
          <div className="space-y-4 sm:space-y-5 mb-8 sm:mb-10">
            {[
              ...
              <div
                key={item.id}
                className={`rounded-xl p-4 sm:p-5 transition-all duration-500 touch-manipulation ${
                  isVisible['touch'] 
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  <div 
                    className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-lg flex items-center justify-center flex-shrink-0"
                  ...
                  <div className="flex-1">
                    ...
                    <p 
                      className="mb-2 sm:mb-3 leading-relaxed text-sm sm:text-base"
                      style={{ color: themeColors.gray }}
                    >
                      {item.description}
                    </p>
        ...
        {/* Connect With Us */}
          ...
          {/* Contact Form */}
          <div 
            className={`grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 transition-all duration-1000 ${
          ...
          >
            {/* Left Side - Form */}
            <div 
              className="rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 order-2 md:order-1"
              style={{ 
            ...
            >
              ...
              <div className="pt-2">
                ...
                <button
                type="submit"
                  className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-base sm:text-lg font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95 touch-manipulation"
                  style={{ 
            ...
            <div className="relative hidden md:block order-1 md:order-2">
              <div 
                className="rounded-xl sm:rounded-2xl overflow-hidden shadow-xl h-full sticky top-8"
                style={{
                  boxShadow: '0 20px 60px rgba(0, 0, 0, 0.15)',
                }}
              >
