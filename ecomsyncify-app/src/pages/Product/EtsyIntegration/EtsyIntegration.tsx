  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: themeColors.white }}>
            ...
            <div className="mb-12 sm:mb-16 md:mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                {[
                  ...
                  <div
                    key={idx}
                    className="feature-card p-4 sm:p-5 md:p-6 rounded-xl border-2 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 touch-manipulation"
                    style={{
      ...
      <style>{`
        ...
        /* Feature Cards Border Animation */
        .feature-card {
          position: relative;
          overflow: visible;
        }
