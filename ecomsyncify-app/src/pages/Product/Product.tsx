  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: themeColors.white }}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
            {products.map((product, index) => (
              <div
                key={index}
                className={`product-card rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 relative border-2 touch-manipulation ${
                  isVisible['products'] 
      ...
      <style>{`
        ...
        /* Product Cards Border Animation */
        .product-card {
          position: relative;
          overflow: visible;
        }
